---
title: "Greenwhich CoM Parishes: Making graphs"
author: "Dave"
format: html
editor: visual
---
...
```{r filesEtc}
abs <- readRDS(
  here("comparative-tables", "2023-09-11_st-marks-dukinfield_population.RDS"))
rel <- readRDS(
  here("comparative-tables", "2023-09-11_st-marks-dukinfield_proportions.RDS"))
```
...
save_path <- str_c(plots_tables_dir, "/2023-09-11_st-marks-dukinfield.RDS")
