---
title: "Jesus Shaped People: Grange Parish, Chester"
author: "Dave"
format: html
editor: visual
params: 
...
parish_shapes <-
  read_sf(in_requested("2023-08-07_john-tomlinson_chester-grange-st-andrew.kml"))
...
hayes <- dir_create(grd, "grange-chester_2023-08-07")

## using this because write_sf appears to be borked
st_write(oa, here(hayes, "grange-chester_oa.geojson"),
         delete_dsn = TRUE)
st_write(parish_shapes, here(hayes, "grange-chester.geojson"),
         delete_dsn = TRUE)
```
...
saveRDS(all_areas_rel, here(save_dir, "2023-08-07_grange-chester_proportions.RDS"))
saveRDS(all_areas_abs, here(save_dir, "2023-08-07_grange-chester_population.RDS"))
```
