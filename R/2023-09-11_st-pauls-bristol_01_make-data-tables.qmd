...
requested_area <- read_sf(
  ...
  query = "SELECT parish_code, parish_name FROM \"coe-parishes_2022\" WHERE parish_code = 550049")
...
hayes <- dir_create(grd, "st-pauls-bristol_2023-09-11")

## using this because write_sf appears to be borked
st_write(oa, here(hayes, "st-pauls-bristol_oa.geojson"),
         delete_dsn = TRUE)
st_write(requested_area, here(hayes, "st-pauls-bristol.geojson"),
         delete_dsn = TRUE)
```
...
saveRDS(all_areas_rel, here(save_dir, "2023-09-11_st-pauls-bristol_proportions.RDS"))
saveRDS(all_areas_abs, here(save_dir, "2023-09-11_st-pauls-bristol_population.RDS"))
```
