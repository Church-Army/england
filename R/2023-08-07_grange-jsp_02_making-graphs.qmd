...
```{r filesEtc}
abs <- readRDS(
  here("comparative-tables", "2023-08-07_grange-chester_population.RDS"))
rel <- readRDS(
  here("comparative-tables", "2023-08-07_grange-chester_proportions.RDS"))
```
...
save_path <- str_c(plots_tables_dir, "/2023-08-07_grange-chester.RDS")
