...
```{r filesEtc}
abs <- readRDS(
  here("comparative-tables", "2023-07-05_greenwhich-parishes_population.RDS"))
rel <- readRDS(
  here("comparative-tables", "2023-07-05_greenwhich-parishes_proportions.RDS"))
```
...
save_path <- str_c(plots_tables_dir, "/2023-07-05_greenwhich-parishes.RDS")
