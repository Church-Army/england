---
title: "St Phillip Upper Stratton: Making graphs"
author: "Dave"
format: html
editor: visual
---
...
```{r filesEtc}
abs <- readRDS(
  here("comparative-tables", "2023-09-11_st-phillip-upper-stratton_population.RDS"))
rel <- readRDS(
  here("comparative-tables", "2023-09-11_st-phillip-upper-stratton_proportions.RDS"))
```
...
save_path <- str_c(plots_tables_dir, "/2023-09-11_st-phillip-upper-stratton.RDS")
