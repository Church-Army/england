---
title: "Area description: St Phillip, Upper Stratton, Diocese of Bristol"
...
message: false
params:
  file: "2023-09-11_st-phillip-upper-stratton.RDS"
  diocese: "Bristol"
  nation: "England"
---
...
This report explores the statistical profile the parish of **St Pauls, Bristol** in the diocese of `r params[["diocese"]]` (plotted in Figure 1).
...
shapes <- read_sf(here("geospatial-reporting-data", 
                       "st-phillip-upper-stratton_2023-09-11",
                       "st-phillip-upper-stratton.geojson"))
