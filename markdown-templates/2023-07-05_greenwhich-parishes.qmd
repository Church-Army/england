---
title: "Area description: Parishes around Greenwhich CoM"
...
message: false
params:
  file: "2023-07-05_greenwhich-parishes.RDS"
  diocese: "Southwark"
  nation: "England"
---
...
This report explores the statistical profiles of two parishes within which Greenwhich CoM operates. These are:

-   St Eltham: St Saviour

-   Abbeywood: St Michael and All Angels
...
shapes <- read_sf(here("geospatial-reporting-data", 
                       "greenwhich-parishes_2023-07-05",
                       "greenwhich-parishes.geojson"))
...
imd_map <-
  ...
  geom_sf(data = lsoa,
          aes(
            fill =
              replace(imd_decile, imd_decile > 4, "other") |> 
              ordered(
                levels = c("1", "2", "3", "4", "other"),
                labels = c("5% most dep.", "10% most dep.",
  ...
  scale_fill_manual(name = "IMD Rank",
                    values = c("white", "red3", "orange2", "yellow3", NA),
                    drop = FALSE) + 
    geom_sf(data = shapes,
          aes(colour = name),
          fill = NA, linewidth= 1,
